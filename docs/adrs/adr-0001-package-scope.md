...
@plasius/graph-client-react is part of the cached graph platform and needs a single responsibility with minimal overlap versus sibling packages.

## Decision

- Keep @plasius/graph-client-react focused on its package-specific concern only.
