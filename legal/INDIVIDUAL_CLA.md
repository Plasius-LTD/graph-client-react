...
**Project:** @plasius/graph-client-react (Plasius LTD)  
...
- **"Project"** means the @plasius/graph-client-react repositories and related materials owned or managed by **Plasius LTD**.
